"use client";
import Link from "next/link";const lessons = [
  "Lesson 1",
  "Lesson 2",
  "Lesson 3",
  "Lesson 4",
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
          ...
          {lessons.map((lesson, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <Link
                     href={`/courses/M1102/chapter-4/lesson-${index + 1}`}
        ...
        <div className="mt-16 rounded-2xl border border-slate-200 bg-white p-7">
          <h2 className="text-2xl font-bold">
            Applications
          </h2>

          <p className="mt-3 text-slate-600">
            Practice exercises related to this chapter.
          </p>

          <button className="mt-6 rounded-xl border border-slate-300 px-5 py-3 font-semibold hover:border-blue-500 hover:text-blue-600">
            Open applications →
          </button>
        </div>
   ...
   <Link 
        href="/courses/M1102/chapter-4/quiz" 
         className="mt-5 inline-flex rounded-xl bg-slate-950 px-6 py-3 font-semibold text-white transition hover:bg-blue-600" >
        Start Chapter Quiz → 
   </Link>
