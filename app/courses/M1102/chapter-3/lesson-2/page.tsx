  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mt-10">
          <VideoPlayer
            videoSrc="/videos/M1102/chapter-3/lesson-2.mp4"
            title="Lesson 2 — M1102"
          />
        </div>
        ...
        <div className="mt-10 flex items-center justify-between">
          <Link
            href="/courses/M1102/chapter-3/lesson-1"
          ...
          <Link
            href="/courses/M1102/chapter-3/lesson-3"
