    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-5">
          <Link
            href="/courses/analysis/chapter-2"
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 3 — Suite arthmetique et geometrique
        </h1>

        {/* Video */}
        <div className="mt-10">
          <VideoPlayer
            videoSrc="youtube:BcKe6mpI53A"
            title="Lesson 3 — Suite arthmetique et geometrique"
          />
        </div>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <h2 className="mt-2 text-2xl font-bold">
            Suite arthmetique et geometrique
          </h2>

          <p className="mt-4 leading-7 text-slate-600">
            In this lesson, you will continue building your
            understanding of the concepts introduced in Chapter 2
        ...
        <div className="mt-10 flex items-center justify-between">
          <Link
            href="/courses/analysis/chapter-2/lesson-2"
          ...
          <Link
            href="/courses/analysis/chapter-2/lesson-4"
