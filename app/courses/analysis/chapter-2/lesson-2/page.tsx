    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 2 — Application sur la limite par définition
        </h1>
        ...
        <div className="mt-10">
          <VideoPlayer
            ...
            title="Lesson 2 — Application sur la limite par définition"
          />
        </div>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <h2 className="mt-2 text-2xl font-bold">
            Application sur la limite par définition
          </h2>

          <p className="mt-4 leading-7 text-slate-600">
            In this lesson, you will continue exploring the concepts
            of Chapter 2 through explanations, examples, and practice.
          </p>
        </div>
        ...
        <div className="mt-10 flex items-center justify-between">
          <Link
            href="/courses/analysis/chapter-2/lesson-1"
          ...
          <Link
            href="/courses/analysis/chapter-2/lesson-3"
            className="rounded-xl bg-slate-950 px-6 py-3 font-semibold text-white transition hover:bg-blue-600"
          >
            Next →
          </Link>
