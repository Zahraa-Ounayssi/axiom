    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 2 — Apllication teoreme d accroissemet fini
        </h1>
        ...
        <div className="mt-10">
          <VideoPlayer
            ...
            title="Lesson 2 — Apllication teoreme d accroissemet fini"
          />
        </div>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <h2 className="mt-2 text-2xl font-bold">
           Apllication teoreme d accroissemet fini
          </h2>

          <p className="mt-4 leading-7 text-slate-600">
            In this lesson, you will continue exploring the concepts
            introduced in Chapter 4 through explanations and examples.
          </p>
        </div>
