    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 3 — Application du théorème de Rolle
        </h1>

        {/* Video */}
        <div className="mt-10">
          <VideoPlayer
            videoSrc="youtube:DzrMIEtiQOg"
            title="Lesson 3 — Application du théorème de Rolle"
          />
        </div>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="mt-4 leading-7 text-slate-600">
            Dans cette leçon, nous étudions l'application du théorème
            de Rolle à travers des explications et des exemples
            mathématiques détaillés.
          </p>
        </div>
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <ul className="mt-5 space-y-4">
            <li className="flex items-start gap-3 text-slate-700">
              ...
              <span>
                Understand the application of Rolle's theorem
              </span>
            </li>
            ...
            <li className="flex items-start gap-3 text-slate-700">
              <span className="font-bold text-blue-600">✓</span>
              <span>
                Identify the conditions required to apply the theorem
              </span>
            </li>
            ...
            <li className="flex items-start gap-3 text-slate-700">
              <span className="font-bold text-blue-600">✓</span>
              <span>
                Apply Rolle's theorem to mathematical examples
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="mt-10 flex items-center justify-between">
          <Link
            href="/courses/analysis/chapter-4/lesson-2"
