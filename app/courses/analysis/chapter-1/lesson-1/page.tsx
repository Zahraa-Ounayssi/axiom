      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="mt-4 leading-7 text-slate-600">
            ...
            of analysis and develop a clear understanding of the
            mathematical ideas introduced in this chapter.
          </p>
        </div>
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <ul className="mt-5 space-y-4">
            <li className="flex items-start gap-3 text-slate-700">
              ...
              <span>Understand the fundamental concepts of analysis</span>
            </li>

            <li className="flex items-start gap-3 text-slate-700">
              <span className="font-bold text-blue-600">✓</span>
              <span>Understand the main mathematical definitions</span>
            </li>

            <li className="flex items-start gap-3 text-slate-700">
              <span className="font-bold text-blue-600">✓</span>
              <span>Apply the concepts to basic mathematical problems</span>
            </li>
          </ul>
        </div>
        ...
        <div className="mt-10 flex items-center justify-between">
          ...
          <Link
            href="/courses/analysis/chapter-1/lesson-2"
