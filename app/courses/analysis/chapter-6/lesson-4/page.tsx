        ...
        <section className="mx-auto max-w-3xl px-6 py-20 text-center">
          <div className="rounded-3xl border border-slate-200 bg-white p-10 shadow-sm">
            ...
            <p className="mx-auto mt-4 max-w-xl leading-7 text-slate-600">
              Lesson 4 is available with an active M1101 subscription.
              Subscribe to access all lessons of this chapter.
            </p>

            <Link
              href="/courses/analysis/chapter-6"
              className="mt-8 inline-block rounded-xl bg-slate-950 px-6 py-3 font-semibold text-white transition hover:bg-blue-600"
            >
              ← Back to Chapter 6
            </Link>
          </div>
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 4 — Application-3
        </h1>

        {/* Video */}
        <div className="mt-10">
          <VideoPlayer
            videoSrc="youtube:2T7MnG1hmTA"
            title="Lesson 4 — Application-3"
          />
        </div>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="mt-4 leading-7 text-slate-600">
            ...
            Chapter 6 through additional mathematical explanations,
