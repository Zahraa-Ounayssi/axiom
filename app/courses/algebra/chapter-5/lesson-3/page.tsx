    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 3 Anneau et Corps
        </h1>

        {/* Video */}
       <div className="mt-10">
                <VideoPlayer
                    videoSrc="/M1100/chapter-05/lesson-03.mp4"
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <h2 className="mt-2 text-2xl font-bold">
            Chapter 5 — Lesson 3 Anneau et Corps
          </h2>
        ...
        <div className="mt-10 flex justify-between">
          ...
          <Link
            href="/courses/algebra/chapter-5/lesson-2"
          ...
          <Link
            href="/courses/algebra/chapter-5/lesson-4"
