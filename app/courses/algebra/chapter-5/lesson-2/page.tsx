    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 2 Groupe part 2
        </h1>

        {/* Video */}
       <div className="mt-10">
                <VideoPlayer
                    videoSrc="/M1100/chapter-05/lesson-02.mp4"
                    title="Lesson 2— Groupe part 2"
                />
           </div>
        {/* Description */}
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <h2 className="mt-2 text-2xl font-bold">
            Chapter 5 — Lesson 2 Groupe part 2
          </h2>

          <p className="mt-4 leading-7 text-slate-600">
            Continue learning the main concepts of Chapter 5
            and develop your understanding step by step.
          </p>
        ...
        <div className="mt-10 flex justify-between">
          ...
          <Link
            href="/courses/algebra/chapter-5/lesson-1"
          ...
          <Link
            href="/courses/algebra/chapter-5/lesson-3"
