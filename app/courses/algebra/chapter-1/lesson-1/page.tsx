    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        <p className="text-sm font-semibold uppercase tracking-wider text-blue-600">
          Chapter 1 theorir des ensembles
        </p>

        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 1 — logique partie 1
        </h1>

        {/* Video */}
       <div className="mt-10">
           <VideoPlayer
  videoSrc="M1100/chapter-01/lesson-01.mp4"
  title="Lesson 01"
/>
      </div>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="mt-4 leading-7 text-slate-600">
            In this lesson, you will learn the basic concepts of
            algebra and understand how algebraic thinking works.
          </p>
        </div>
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <ul className="mt-5 space-y-4">
            <li className="flex items-start gap-3 text-slate-700">
              ...
              <span>Understand the meaning of algebra</span>
            </li>

            <li className="flex items-start gap-3 text-slate-700">
              <span className="font-bold text-blue-600">✓</span>
              <span>Identify variables and constants</span>
            </li>

            <li className="flex items-start gap-3 text-slate-700">
              <span className="font-bold text-blue-600">✓</span>
              <span>Understand basic algebraic notation</span>
            </li>
          </ul>
        </div>
