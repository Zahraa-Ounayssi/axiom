      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
       ...
       <div className="mt-10">
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="text-sm font-semibold text-blue-600">
            Lesson 2 part 2 Racine n eme d un nb complexe et resoudre equation de second degre dans C
          </p>
        ...
        <div className="mt-10 flex justify-between">
          ...
          <Link
            href="/courses/algebra/chapter-6/lesson-1"
          ...
          <Link
            href="/courses/algebra/chapter-6/lesson-3"
