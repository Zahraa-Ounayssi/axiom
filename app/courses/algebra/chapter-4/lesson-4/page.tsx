    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 4 Homomorphisme
        </h1>

        {/* Video */}
        <div className="mt-10">
               <VideoPlayer
                   videoSrc="youtube:yt8nUWeCe4s"
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <h2 className="mt-2 text-2xl font-bold">
            Chapter 4 — Lesson 4 Homomorphisme
          </h2>

          <p className="mt-4 leading-7 text-slate-600">
            Continue developing your understanding of Chapter 4
            through explanations, examples, and mathematical practice.
          </p>
        ...
        <div className="mt-10 flex justify-between">
          ...
          <Link
            href="/courses/algebra/chapter-4/lesson-3"
          ...
          <Link
            href="/courses/algebra/chapter-4/lesson-5"
