    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 1 loi de composition interne
        </h1>

        {/* Video */}
        <div className="mt-10">
              <VideoPlayer
                  videoSrc="/M1100/chapter-04/lesson-01.mp4"
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="text-sm font-semibold text-blue-600">
            Lesson 1 part 1  loi de composition interne
          </p>
          ...
          <p className="mt-4 leading-7 text-slate-600">
            ...
            introduced in Chapter 4 and build the foundation for the
            following lessons.
          </p>
       ...
       {/* Video */}
        <div className="mt-10">
              <VideoPlayer
                  videoSrc="/M1100/chapter-04/lesson-02.mp4"
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="text-sm font-semibold text-blue-600">
            Lesson 1 part 2 loi de composition interne
          </p>
