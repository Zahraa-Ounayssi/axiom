    ...
    <main className="min-h-screen bg-[#f7f9fc] px-6 py-10">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {/* Video */}
               <div className="mt-10">
                           <VideoPlayer
                               videoSrc="/courses/videos/algebra/final/session-1/explanation.mp4"
                               title="Session 3— "
                           />
                      </div>
        ...
        <section className="mb-8 rounded-3xl bg-white p-6 shadow-sm">
          ...
          <a
            href="/pdfs/algebra/final/session-3/exam.pdf"
            target="_blank"
        ...
        <section className="mb-8 rounded-3xl bg-white p-6 shadow-sm">
          ...
          <a
            href="/pdfs/algebra/final/session-3/correction.pdf"
            target="_blank"
            rel="noopener noreferrer"
