...
const questions = [
  {
    question: "&  racine de f(x)",
    options: ["f(x)=(x-&)q(x)", "f(x)=(x-&)**2 q(x)", "f(x)=(x-&)", "f(&)=(x-&)q(&)"],
    correct: 0,
  },
  {
    question: "g(x) divise f(x) <=>",
    options: ["f(x)=&g(x)", "f(x)=g(x)q(x)", "f(x)-r(x)=g(x)", "f(x)=g(x)q(x)+r(x)"],
    correct: 1,
  },
];
        ...
        <div className="w-full max-w-2xl rounded-3xl bg-white p-10 text-center shadow-sm">
          ...
          >
            Try Again
                    ...
                    <button
               onClick={() => {
               window.location.href = "/courses/algebra/chapter-7";
               }}
