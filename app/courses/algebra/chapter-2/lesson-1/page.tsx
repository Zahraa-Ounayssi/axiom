    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 1 Application et l image
        </h1>
        ...
        <div className="mt-10 flex justify-between">
          <Link
            href="/courses/algebra/chapter-2"
            className="rounded-xl border border-slate-300 bg-white px-5 py-3 font-semibold transition hover:border-blue-500 hover:text-blue-600"
          >
            ← Previous
          </Link>

          <Link
            href="/courses/algebra/chapter-2/lesson-2"
