...
const questions = [
  {
    question: "gof A dans B  existe",
    options: ["f A dans B et g B dans C", "g A dans B et f B dans C", "f B dans A et g C dans B", "g B dans A et f C dans B"],
    correct: 0,
  },
  {
    question: "gof injective",
    options: ["f et g est injective ", "f est injective", "g est injective", "pas de conclusion"],
    correct: 1,
  },
  {
    question: "inverse gof",
    options: ["inverse g o inverse f", "go inverse f", "inverse f o inverse g", "f o inverse g"],
    correct: 2,
  },
        ...
        <div className="w-full max-w-2xl rounded-3xl bg-white p-10 text-center shadow-sm">
          ...
          >
            Try Again
                    ...
                    <button
               onClick={() => {
               window.location.href = "/courses/algebra/chapter-2";
               }}
