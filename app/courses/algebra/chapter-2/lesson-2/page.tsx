    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <h1 className="mt-3 text-4xl font-bold md:text-5xl">
          Lesson 2 Application Injective Surjective et Bijective
        </h1>

        <div className="mt-10">
             <VideoPlayer
                 videoSrc="youtube:_GER_-f3x60"
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          <p className="text-sm font-semibold text-blue-600">
            Lesson 2 part 1  Application Injective Surjective et Bijective
          </p>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-7">
          <p className="text-sm font-semibold text-blue-600">
            Lesson 2 part 2 Application Injective Surjective et Bijective
          </p>

          <h2 className="mt-2 text-2xl font-bold">
            Lesson 2 part2  Application Injective Surjective et Bijective
          </h2>
        ...
        <div className="mt-10 flex justify-between">
          <Link
            href="/courses/algebra/chapter-2/lesson-1"
